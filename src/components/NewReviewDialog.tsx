/**
 * @deprecated This component has been replaced by CreateFormalReviewDialog + FormalReviewSheet.
 * Kept temporarily for reference. No longer imported by any file.
 */
