...
// Visível apenas para HR Admin / Owner. Aparece quando Slack está conectado.
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Switch } from '@/components/ui/switch';
import { Label } from '@/components/ui/label';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Eye, ShieldCheck, Hash, Loader2 } from 'lucide-react';
...
export function AmbientSlackSettings() {
  ...
  const busy = updateAutojoin.isPending || updateAmbientEnabled.isPending;
      ...
      <CardHeader className="flex flex-row items-start gap-3 space-y-0">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {!canEdit && (
              <Badge variant="outline" className="text-[10px] px-1.5 py-0">Somente leitura</Badge>
            )}
          </div>
