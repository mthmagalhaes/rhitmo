      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end items-start text-white p-16">
          ...
          <div className="border-l-4 border-emerald-400 pl-6">
            ...
            <p className="text-xl text-left text-white/80 max-w-md leading-relaxed">Com o Rhitmo, líderes ganham tempo, memória e organização de forma simples para focar no que realmente importa: <span className="bg-emerald-400 text-white px-1.5 py-0.5 rounded"><span className="whitespace-nowrap">desenvolver pessoas</span> e construir uma cultura de resultados.</span></p>
          </div>
        </div>
      </div>
