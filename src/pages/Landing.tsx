...
const translations = {
  pt: {
    ...
    numbersLabel1: "Gestores dedicam 210 horas por ano a avaliações de desempenho. São cinco semanas inteiras. Só a redação consome 65 horas. Com Rhitmo, o draft sai pronto em segundos.",
    numbersStat2: "38x",
  ...
  en: {
    ...
    numbersStat1: "4h → 2min",
    numbersLabel1: "Managers spend 210 hours per year on performance reviews. That's five full weeks. Writing alone takes 65 hours. With Rhitmo, the draft is ready in seconds.",
    numbersStat2: "38x",
