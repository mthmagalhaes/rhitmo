...
const translations = {
  pt: {
    ...
    numbersLabel1: (<>Gestores dedicam <span className="highlight-marker">210 horas por ano</span> a avaliações de desempenho. São <span className="highlight-marker">cinco semanas inteiras</span>. Só a redação consome 65 horas. Com Rhitmo, o draft sai pronto em segundos.</>),
    numbersStat2: "38x",
  ...
  en: {
    ...
    numbersStat1: "4h → 2min",
    numbersLabel1: (<>Managers spend <span className="highlight-marker">210 hours per year</span> on performance reviews. That's <span className="highlight-marker">five full weeks</span>. Writing alone takes 65 hours. With Rhitmo, the draft is ready in seconds.</>),
    numbersStat2: "38x",
