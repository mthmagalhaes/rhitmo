...
interface SyncInviteProps {
  memberName?: string
  syncUrl?: string
}

const SyncInviteEmail = ({ memberName, syncUrl }: SyncInviteProps) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Complete seu Rhitmo Sync — Apenas 1 minuto! ⚡</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        {syncUrl && (
          <Section style={buttonSection}>
            <Button style={button} href={syncUrl}>
              Preencher Rhitmo Sync ⚡
            </Button>
          </Section>
        )}
        <Text style={hint}>Otimizado para celular 📱 | Leva menos de 1 minuto</Text>
...
export const template = {
  component: SyncInviteEmail,
  subject: 'Complete seu Rhitmo Sync — Apenas 1 minuto! ⚡',
  displayName: 'Convite Rhitmo Sync',
  previewData: { memberName: 'Maria', syncUrl: 'https://rhitmo.co/sync/abc123' },
